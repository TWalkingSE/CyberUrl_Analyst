...
def extract_url_features(url: str) -> dict:
    ...
    features["num_percent_encoding"] = len(re.findall(r'%[0-9A-Fa-f]{2}', url))
...
class MLClassifier:
    ...
    def load_model(self) -> bool:
        ...
        try:
            ...
            logger.info(
                "Modelo ML carregado de %s (acurácia: %.2f%%)",
                MODEL_PATH, self._accuracy * 100,
            )
            return True
    ...
    def predict(self, url: str) -> MLPrediction:
        ...
        try:
            ...
            # Índice 0 = safe (label 0), índice 1 = malicious (label 1)
