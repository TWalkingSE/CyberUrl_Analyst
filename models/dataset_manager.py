...
_MAX_ENTRIES = DATASET_MAX_ENTRIES
...
class DatasetManager:
                ...
                if has_header:
                    ...
                    for row in reader:
                        ...
                        if url and url.startswith("http"):
                            self._add_url_entry(dataset_id, url)
                            count += 1
                else:
                    ...
                    for row in reader:
                        ...
                        for field in row:
                            ...
                            if field.startswith("http"):
                                self._add_url_entry(dataset_id, field)
                                count += 1
                                break
        except Exception as e:
        ...
        try:
            with open(path, "r", encoding="utf-8", errors="ignore") as f:
                ...
                for row in reader:
                    ...
                    if domain:
                        self._add_domain_entry(dataset_id, domain, target)
                        count += 1
        except Exception as e:
            ...
            with open(path, "r", encoding="utf-8", errors="ignore") as f:
                for line in f:
                    ...
                    if domain and not domain[0].isdigit():
                        ...
                        self._add_domain_entry(dataset_id, parts[1].strip().lower(), target)
                        count += 1
        except Exception as e:
    ...
    def _add_url_entry(self, dataset_id: str, url: str):
    ...
    def _add_domain_entry(self, dataset_id: str, domain: str, target: str):
