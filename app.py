...
def build_main_window(state: AppState | None = None) -> tuple[AppState, MainWindow]:
    """
    Monta janela e estado sem executar o loop de eventos.

    Usado pelos testes de integração (tests/test_app_integration.py) para
    instanciar a UI headless; `main()` constrói a MainWindow diretamente.
    """
